...
CompanyFeedbackList _$CompanyFeedbackListFromJson(Map<String, dynamic> json) {
  return _CompanyFeedbackList.fromJson(json);
}

/// @nodoc
mixin _$CompanyFeedbackList {
  ...
  @JsonKey(ignore: true)
  $CompanyFeedbackListCopyWith<CompanyFeedbackList> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CompanyFeedbackListCopyWith<$Res> {
  factory $CompanyFeedbackListCopyWith(
          CompanyFeedbackList value, $Res Function(CompanyFeedbackList) then) =
      _$CompanyFeedbackListCopyWithImpl<$Res>;
  $Res call(
      {int? id,
...
/// @nodoc
class _$CompanyFeedbackListCopyWithImpl<$Res>
    implements $CompanyFeedbackListCopyWith<$Res> {
  _$CompanyFeedbackListCopyWithImpl(this._value, this._then);

  final CompanyFeedbackList _value;
  // ignore: unused_field
  final $Res Function(CompanyFeedbackList) _then;
    ...
    return _then(_value.copyWith(
      ...
      isAnonym: isAnonym == freezed
          ...
          : isAnonym // ignore: cast_nullable_to_non_nullable
              as bool?,
      isReplied: isReplied == freezed
          ? _value.isReplied
          : isReplied // ignore: cast_nullable_to_non_nullable
              as bool?,
      isSolved: isSolved == freezed
          ? _value.isSolved
...
/// @nodoc
abstract class _$CompanyFeedbackListCopyWith<$Res>
    implements $CompanyFeedbackListCopyWith<$Res> {
  factory _$CompanyFeedbackListCopyWith(_CompanyFeedbackList value,
          $Res Function(_CompanyFeedbackList) then) =
      __$CompanyFeedbackListCopyWithImpl<$Res>;
  @override
  $Res call(
      {int? id,
      String? customerFirstName,
...
/// @nodoc
class __$CompanyFeedbackListCopyWithImpl<$Res>
    extends _$CompanyFeedbackListCopyWithImpl<$Res>
    implements _$CompanyFeedbackListCopyWith<$Res> {
  __$CompanyFeedbackListCopyWithImpl(
      _CompanyFeedbackList _value, $Res Function(_CompanyFeedbackList) _then)
      : super(_value, (v) => _then(v as _CompanyFeedbackList));

  @override
  _CompanyFeedbackList get _value => super._value as _CompanyFeedbackList;
...
/// @nodoc
@JsonSerializable()
class _$_CompanyFeedbackList implements _CompanyFeedbackList {
  ...
  factory _$_CompanyFeedbackList.fromJson(Map<String, dynamic> json) =>
      _$$_CompanyFeedbackListFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$CompanyFeedbackListCopyWith<_CompanyFeedbackList> get copyWith =>
      __$CompanyFeedbackListCopyWithImpl<_CompanyFeedbackList>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CompanyFeedbackListToJson(this);
  }
}

abstract class _CompanyFeedbackList implements CompanyFeedbackList {
  factory _CompanyFeedbackList(
      {final int? id,
      final String? customerFirstName,
      final String? title,
      final String? text,
  ...
  factory _CompanyFeedbackList.fromJson(Map<String, dynamic> json) =
      _$_CompanyFeedbackList.fromJson;
