...
/// @nodoc
mixin _$CommentList {
  List<dynamic>? get childComment => throw _privateConstructorUsedError;
...
class _$_CommentList implements _CommentList {
  ...
  final List<dynamic>? _childComment;
  @override
  List<dynamic>? get childComment {
  ...
  @override
  String toString() {
    return 'CommentList(childComment: $childComment, isActive: $isActive, isChecked: $isChecked, id: $id, userId: $userId, userName: $userName, parentCommentId: $parentCommentId, text: $text, likeCount: $likeCount, dislikeCount: $dislikeCount, isAnonym: $isAnonym, createdAt: $createdAt)';
  }
...
abstract class _CommentList implements CommentList {
  factory _CommentList(
      ...
      final int? dislikeCount,
      final bool? isAnonym,
      final DateTime? createdAt}) = _$_CommentList;
