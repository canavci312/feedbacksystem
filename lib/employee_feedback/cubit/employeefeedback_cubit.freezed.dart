...
abstract class _$$_SuccessCopyWith<$Res> {
  ...
  $Res call(
      {List<CompanyFeedbackList> list, List<CompanyFeedbackList> filteredList});
}
...
class _$_Success implements _Success {
  ...
  @override
  String toString() {
    return 'EmployeeFeedbackState.success(list: $list, filteredList: $filteredList)';
  }
...
abstract class _Success implements EmployeeFeedbackState {
  const factory _Success(final List<CompanyFeedbackList> list,
      final List<CompanyFeedbackList> filteredList) = _$_Success;
